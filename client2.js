...
renderer.setClearColor(0xdffcce7);
...
const loader = new GLTFLoader().load(
  "./assets/donut_noPlane.glb", // comment this line out and un comment the line below to swithc models
